...
class GPETimeEv():
    ...
    def __init__(self, L = 20, dtcoef = 0.1, npoints = 2**9, dim = 1, winMult = 2, numVort = 10, spawnType = 'No', tol = 10e-10, Nfactor = 1000, numImagSteps = 2000, numRealSteps = 10000,  antiV = False, dist = 2, runDyn = True, imp = False, impPsi = None): 
    ...
    def setbox(self):
        ...
        '''
        V = 0
        self.height = self.kmax**2/2*2 # adjust this height coefficient as needed 
        self.steepness = 2
        #self.height =5
        for i in range(self.dim):
